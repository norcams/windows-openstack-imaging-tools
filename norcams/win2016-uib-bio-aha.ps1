...
$windowsImagePath = "C:\os-builder\images\win2016-server.uib-bio-aha.qcow2"
...
$VirtIOISOPath = "C:\os-builder\virtio.iso"
...
New-WindowsOnlineImage -WimFilePath $wimFilePath -ImageName $image.ImageName `
    ...
    -SizeBytes 30GB -CpuCores 2 -Memory 4GB -SwitchName $switchName `
    ...
    -SoftwareInstall:$true -SoftwareList "geo-aha-software.ps1" `
    -SoftwareCreds "netcredentials.txt" -Verbose
